...
if (isset($_POST["edit"])) {
    if (edit($_POST) > 0) {
      echo "<script>
            alert('Restoran berhasil diperbarui!');
            document.location.href = 'Restaurant.php';
            </script>";
    }
    else {
        echo "<script>
            alert('Restoran gagal diperbarui!');
            document.location.href = 'Restaurant.php';
            </script>";
    }
                ...
                <div class="col-sm-12">
                    <div class="card mx-auto mb-5">
                        ...
                        <form action="" method="post" class="my-3 mb-5 mx-5">
                            ...
                            <div class="input">
                                <input type="text" name="Rname" id="Rname" class="form-control" placeholder="Restaurant Name" required value="<?= $restaurants['name']?>">
                            </div>
                            <br>
                            <div class="input">
                            ...
                            <br>
                            <div class="input">
                                <input type="text" name="location" id="location" class="form-control" placeholder="Location (jika lebih dari 1 pisahkan dengan tanda ' , ' )" required value="<?= $restaurants['location']?>">
                            </div>
                            <br>
                            <div class="input">
                            ...
                            <div style="margin-block: 5px;">
                                <textarea name="review" id="review" placeholder="Type your review" required><?= $restaurants['review']?></textarea>
                            </div>
                            <br>
                            <div class="regisPosition text-center">
                              <button type="submit" name="edit" class="addbtn">Edit</button>
